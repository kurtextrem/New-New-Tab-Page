+function (window, $) {
	...
	WeatherFetcher.prototype.requestLocation_ = function() {
		...
		navigator.geolocation.getCurrentPosition(this.handleGeolocationResponse_.bind(this), function() {
	...
	WeatherFetcher.prototype.requestLocationName_ = function() {
		...
		$.get(util.makeURL('https://maps.googleapis.com/maps/api/geocode/json', params))
		.success(this.handleLocationResponse_.bind(this))
	...
	WeatherFetcher.prototype.requestWeather_ = function() {
		...
		$.get(util.makeURL('http://ntpserv.appspot.com/weather', params), {}, {type: 'json'})
		.success(this.handleWeatherResponse_.bind(this))
		.error(function() {
	...
	window.weatherFetcher = new WeatherFetcher()
} (window, qwest);
