+function(window) {
	 ...
	 */
	 util.scaleCanvas = function(canvas, newWidth, newHeight) {
		...
		var dest1 = {height: src.height, width: newWidth, data: new Array(src.height * newWidth * 4)};
		util.doScaleX_(src, dest1);
		dest1 = util.transpose_(dest1);

		var dest2 = {height: dest1.height, width: newHeight, data: new Array(dest1.height * newHeight * 4)};
	...
	util.transpose_ = function(src) {
		var dest = {width: src.height, height: src.width, data: new Array(src.data.length)};
