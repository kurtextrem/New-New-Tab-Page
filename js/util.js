...
util.doScaleX_ = function(src, dest) {
  ...
  for (var y = 0; y < dest.height; y++) {
    for (var xnew = 0; xnew < dest.width; xnew++) {
      var x = xnew / ratio;
      dest.data[j] = 0;  dest.data[j + 1] = 0;
      dest.data[j + 2] = 0;  dest.data[j + 3] = 0;
      var sum_weight = 0;
      ...
      dest.data[j] /= sum_weight;  dest.data[j + 1] /= sum_weight;
      dest.data[j + 2] /= sum_weight;  dest.data[j + 3] /= sum_weight;
